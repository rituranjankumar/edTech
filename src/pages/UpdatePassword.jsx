      ...
      <form onSubmit={handleOnSubmit}>
        <label className="relative">
          ...
          <input
            ...
            className="form-style bg-richblack-700 p-3 rounded-lg text-richblack-100 w-full !pr-10 text-sm sm:text-base"
          />
          <span
        ...
        <label className="relative mt-3 block">
          ...
          <input
            ...
            className="form-style p-3 bg-richblack-700 rounded-lg text-richblack-100 w-full !pr-10 text-sm sm:text-base"
          />
          <span
