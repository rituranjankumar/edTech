...
function VerifyEmail() {
  ...
  return (
<div className="min-h-[calc(100vh-3.5rem)] grid place-items-center p-4 sm:p-6">
  {loading ? (
    <div>
    ...
    <div className="max-w-[500px] w-full p-4 lg:p-8">
      <h1 className="text-richblack-5 font-semibold text-2xl sm:text-[1.875rem] leading-[2.375rem]">
        Verify Email
      </h1>
      ...
      <form onSubmit={handleVerifyAndSignup}>
        ...
        <button
          type="submit"
          className="w-full bg-yellow-50 py-2 sm:py-[12px] px-3 sm:px-[12px] rounded-[8px] mt-4 sm:mt-6 font-medium text-richblack-900 text-sm sm:text-base"
        >
          Verify Email
        </button>
      </form>
