...
const LearningGrid = () => {
  return (
    <div className='grid grid-cols-1 sm:gap-2 sm:grid-cols-2 lg:grid-cols-4 mb-10 p-5 lg:w-fit'>
    {
        LearningGridArray.map( (card, index) => {
            return (
                ...
                >
                {
                    card.order < 0 
                    ? (
                        <div className='lg:w-[90%] sm:w-full flex flex-col sm:pb-5 xs:gap-3'>
