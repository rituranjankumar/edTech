...

                                {
                                    ssubLinks.length ? (
                                            ssubLinks.map( (subLink, index) => (
                                                <Link className='flex  w-full h-fit' to={`/catalog/${subLink.name.split(" ").join("-")}`} key={index}>
                                                    <p  className='text-lg hover:bg-richblack-50 rounded-lg w-full p-2'>{subLink.name}</p>
                                                </Link>
                                            ) )
                                    ) : (<div></div>)
                                }
