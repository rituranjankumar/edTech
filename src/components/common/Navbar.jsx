...
const Navbar = () => {
    ...
    return (
        <div className='flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 px-2 sm:px-4'>
            <div className='flex w-full max-w-maxContent items-center justify-between'>

                {/* Image */}
                <Link to="/">
                    <img src={logo} width={120} height={40} loading='lazy' className="sm:w-[160px] sm:h-[42px]" />
                </Link>
