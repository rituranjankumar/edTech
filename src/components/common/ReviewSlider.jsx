                ...
                >
                    {
                        reviews.map((review, index) => (
                            <SwiperSlide key={index}>
                                <div className='bg-richblack-800 p-4 rounded-md shadow-md h-full flex flex-col gap-2'>
                                    ...
                                    <p className='text-richblack-5 text-sm line-clamp-3'>{review?.review}</p>
                                    <div className='flex items-center gap-2'>
                                        <span className='text-yellow-100 font-bold text-sm'>{review?.rating.toFixed(1)}</span>
